...
public class PhongIlluminationModel {
    ...
    private Color computeAmbientComponent() {
        ...
        return (Color) ambientColor.componentWiseMultiply(material.getDiffuseColor().multiplyNew(ambientCoefficient * ambientIntensity)); // Apparently the ambient light is only dependent on the material's diffuse color.
    }
    ...
    private Color computeSpecularComponent() {
        ...
        return (Color) lightColor.componentWiseMultiply(specularColor.multiplyNew(specularCoefficient * viewingAngleDependentIntensityFactor));
    }
    ...
    private Color computeDiffuseComponent() {
        ...
        Color lightColor = currentLight.getColor();
        return (Color) lightColor.componentWiseMultiply(material.getDiffuseColor().multiplyNew(diffuseCoefficient * angleDependentIntensityFactor));
    }
